...
var DEFAULT_EXPENSE_ROWS = [
  ...
  { label: 'Courses', amount: 0 },
  { label: 'Électricité / Gaz', amount: 0 },
  { label: 'Internet / Téléphone', amount: 0 },
...
function updateAnnualLabel(idx, val) { getAnnualExpenses()[idx].label = val; }
